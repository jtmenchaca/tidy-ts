...
export const Route = createFileRoute(
  "/examples/comprehensive-workflows" as any,
)({
  component: ComprehensiveWorkflowsComponent,
});

function ComprehensiveWorkflowsComponent() {
  return (
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Real-world data analysis workflows that combine all tidy-ts
            features. These examples show how to use the library effectively.
          </p>
        </div>
        ...
        <CodeBlock
          ...
          code={`import { createDataFrame, stats, read_csv } from "@tidy-ts/dataframe";
import { z } from "zod";
...
analysis.print("Complete analysis results:");`}
        ...
        <CodeBlock
          title="Async Data Enrichment Workflow"
          description="Handling asynchronous operations in a real-world data pipeline"
          explanation="This workflow shows how to handle asynchronous operations like API calls and data validation while maintaining type safety and performance."
          code={`// Simulate external API calls
...
enrichedAnalysis.print("Async enriched analysis:");`}
        ...
        <CodeBlock
          title="Data Quality and Cleaning Pipeline"
          description="Comprehensive data cleaning and quality assessment"
          explanation="This workflow demonstrates comprehensive data quality assessment and cleaning, including missing data analysis and intelligent imputation strategies."
          code={`// Messy real-world data
...
cleanedData.print("Cleaned data:");`}
        ...
        <Card>
          <CardHeader>
            <CardTitle>Advanced Joining and Reshaping</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                <h4 className="font-medium mb-2">Multi-Table Analysis</h4>
                <CodeBlock
                  code={`// Employee and department data
...
departmentAnalysis.print("Department analysis:");`}
              ...
              <div>
                ...
                <CodeBlock
                  code={`// Sales data in long format
