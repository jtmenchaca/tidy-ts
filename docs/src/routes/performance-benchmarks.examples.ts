  ...
  fiveHundredKBenchmarkData: [
    {
      ...
      sortOrder: 1,
      values: [
        { library: "tidy-ts", timeMs: 56.0, ratio: 1 },
        { library: "arquero", timeMs: 36.772, ratio: 0.7 },
        { library: "pandas", timeMs: 666.927, ratio: 11.9 },
        { library: "polars", timeMs: 8.966, ratio: 0.2 },
