...
export const performanceBenchmarksExamples = {
  ...
  fiveHundredKBenchmarkData: [
    ...
    },
    {
      ...
      sortOrder: 11,
      values: [
        { library: "tidy-ts", timeMs: 156.6, ratio: 1.0 },
        { library: "arquero", timeMs: 78.8, ratio: 0.5 },
        { library: "pandas", timeMs: 8.3, ratio: 0.05 },
        { library: "polars", timeMs: 2.4, ratio: 0.02 },
        { library: "dplyr", timeMs: 7.5, ratio: 0.05 },
      ],
    },
  ],
};