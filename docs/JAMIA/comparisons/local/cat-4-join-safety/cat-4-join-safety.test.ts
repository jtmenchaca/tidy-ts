...
const INTENTS = [
  "Left-join labs to encounters on a key that does not exist on the left table.",
  "Left-join labs to encounters on a misspelled key.",
  "Left-join labs to encounters, then access a column expected to be present.",
  "Left-join encounters with patient details, then uppercase the patient name column.",
  "Left-join encounters with stays, then divide length of stay in days by 7.",
  "Left-join encounters with stays, then filter where length of stay is greater than 2.",
  "Inner-join two tables with column collisions using an explicit suffix, then access the original column name.",
  "Inner-join two tables with column collisions using the default suffix, then access the original column name.",
];
