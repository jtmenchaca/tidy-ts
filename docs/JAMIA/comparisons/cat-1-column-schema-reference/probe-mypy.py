"""Probe: Category 1 — Mypy static type checking of column/schema reference errors.

Generates a Python file with all 16 cat-1 error cases, runs mypy in strict
...
TARGET_CODE = '''\
"""Cat-1 column & schema reference cases for mypy static analysis."""
import pandas as pd
import warnings
