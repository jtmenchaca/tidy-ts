...
<div class="pipeline">
  ...
  <div class="stage zone-boundary">
    ...
    <div class="stage-desc">Checks each row against the expected structure when data enters the program. Rejects unexpected data types, missing required fields, unexpected null values, and invalid categorical values.</div>
  </div>
  <div class="arrow"><div class="arrow-line"></div><div class="arrow-head"></div></div>
  <div class="stage zone-typed">
    <span class="badge badge-compile">Compile-time check</span>
    <div class="stage-label">DataFrame with Tracked Columns</div>
    <div class="stage-desc">Tracks the available columns, their types, and whether values may be missing. Each table operation updates the tracked columns accordingly.</div>
  </div>
  <div class="arrow"><div class="arrow-line"></div><div class="arrow-head"></div></div>
  <div class="stage zone-typed">
    <span class="badge badge-compile">Compile-time check</span>
    <div class="stage-label">Table Operations</div>
