...
- [s.dist.pareto.density](#sdistparetodensity)
- [s.dist.pareto.probability](#sdistparetoprobability)
- [s.dist.pareto.quantile](#sdistparetoquantile)
- [s.dist.pareto.random](#sdistparetorandom)
- [s.dist.pareto.data](#sdistparetodata)
...
Density value or log density (0 if at < scale)
...
`s.dist.pareto.probability`, `s.dist.pareto.quantile`, `s.dist.pareto.random`
...
`s.dist.pareto.density`, `s.dist.pareto.quantile`, `s.dist.pareto.random`
...
`s.dist.pareto.density`, `s.dist.pareto.probability`, `s.dist.pareto.random`
...
Random sample(s) from the Pareto distribution (values ≥ scale)
...
`s.dist.pareto.density`, `s.dist.pareto.probability`, `s.dist.pareto.quantile`
