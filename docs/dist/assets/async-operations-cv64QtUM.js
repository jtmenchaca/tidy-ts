import{j as e}from"./vega-DaDS7kWN.js";import{C as a}from"./code-block-DNrkRg0G.js";import{C as s,a as r,b as i,c as n,d as o}from"./card-BHRuJ_3B.js";import{D as c}from"./DocPageLayout-DA3oHHtz.js";import"./recharts-BW8nexKl.js";import"./shiki-wKCgTG-o.js";import"./shiki-themes-BheiPiei.js";import"./index-Bn-fflGs.js";import"./radix-CNB_C82Z.js";const t={asyncMutateOperations:`import { createDataFrame } from "@tidy-ts/dataframe";
...
heavyValidatedCharacters.print("Heavy validated characters:");`,asyncAggregation:`import { createDataFrame, stats } from "@tidy-ts/dataframe";
...
}`};function w(){return e.jsxs(c,{title:"Async Operations",description:"Handle asynchronous operations seamlessly across all tidy-ts functions. From API calls to file operations, async support is built-in with full type safety and performance optimization.",currentPath:"/async-operations",children:[e.jsx(a,{title:"Async Mutate Operations",description:"Add calculated columns using asynchronous functions",explanation:"You can mix synchronous and asynchronous operations in the same mutate() call. Perfect for API enrichment, data validation, and external service integration.",code:t.asyncMutateOperations}),e.jsx(a,{title:"Async Filtering",description:"Filter rows based on asynchronous conditions",explanation:"Async filtering is perfect for scenarios where you need to validate data against external APIs, databases, or perform complex async calculations.",code:t.asyncFiltering}),e.jsx(a,{title:"Async Aggregation",description:"Handle asynchronous operations in group summaries",explanation:"Group summaries can include async operations to enrich your data with external information while maintaining type safety.",code:t.asyncAggregation}),e.jsx(a,{title:"Error Handling",description:"Gracefully handle async operation failures",explanation:"Async operations can fail, and tidy-ts provides clean error handling patterns for managing these scenarios in your data pipelines.",code:t.errorHandling}),e.jsxs(s,{children:[e.jsxs(r,{children:[e.jsx(i,{children:"Concurrency and Retries"}),e.jsx(n,{children:"Tidy-ts has baked-in concurrency control and retry mechanisms"})]}),e.jsx(o,{children:e.jsx("div",{children:e.jsx(a,{code:t.concurrencyAndRetries})})})]})]})}export{w as component};
