import{j as e}from"./vega-DaDS7kWN.js";import{C as i}from"./code-block-BK1m5zSl.js";import{C as r,a as t,b as n,c as a,d as o}from"./card-DtA_hQgo.js";import{D as l}from"./DocPageLayout-CxyjlLoX.js";import"./recharts-BW8nexKl.js";import"./shiki-BpdrxAJG.js";import"./shiki-themes-BheiPiei.js";import"./index-C-RFQN-p.js";import"./radix-CNB_C82Z.js";const s={basicFiltering:`import { createDataFrame } from "@tidy-ts/dataframe";
...
chainedFilter.print("Tall humans (chained filters):");`};function w(){return e.jsxs(l,{title:"Filtering Rows",description:"Filtering lets you work with subsets of your data based on specific conditions. Learn both synchronous and asynchronous filtering patterns.",currentPath:"/filtering-rows",children:[e.jsx(i,{title:"Basic Filtering",description:"Filter rows based on simple conditions",explanation:"The filter() function creates a new DataFrame containing only rows that match your condition. You can use any combination of column values and logical operators.",code:s.basicFiltering}),e.jsx(i,{title:"Using (row, index, df) Parameters in Filter",description:"Learn how to use all three parameters available in filter functions",explanation:"row: Current row's data • index: Row position (0-based) • df: Entire DataFrame",code:s.filterWithParameters}),e.jsx(i,{title:"Complex Filtering Conditions",description:"Use sophisticated logic for advanced filtering scenarios",explanation:"You can combine multiple conditions using logical operators (&&, ||, !) and even filter based on calculated values from previous transformations.",code:s.filterWithCalculations}),e.jsxs(r,{children:[e.jsxs(t,{children:[e.jsx(n,{children:"Async Filtering"}),e.jsx(a,{children:"Handle asynchronous operations in your filter conditions"})]}),e.jsxs(o,{children:[e.jsx("p",{className:"mb-4",children:"Filter functions support async operations for validating data against external APIs, databases, or performing complex async calculations. All async operations are automatically handled with proper concurrency control."}),e.jsxs("p",{className:"text-sm text-blue-600 dark:text-blue-400",children:["📖 ",e.jsx("strong",{children:"Learn more:"})," See the"," ",e.jsx("a",{href:"/async-operations",className:"underline hover:no-underline",children:"Async Operations"})," ","page for comprehensive async filtering examples and patterns."]})]})]}),e.jsxs(r,{children:[e.jsxs(t,{children:[e.jsx(n,{children:"Filtering Patterns"}),e.jsx(a,{children:"Common filtering patterns and best practices"})]}),e.jsx(o,{children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Range Filtering"}),e.jsx(i,{code:s.chainedFiltering})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Null and Missing Value Filtering"}),e.jsx(i,{code:s.basicFiltering})]})]})})]}),e.jsxs(r,{children:[e.jsxs(t,{children:[e.jsx(n,{children:"Performance Considerations"}),e.jsx(a,{children:"Tips for efficient filtering operations"})]}),e.jsx(o,{children:e.jsx("div",{className:"space-y-4",children:e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-2",children:"Chaining Filters"}),e.jsx(i,{code:s.chainedFiltering})]})})})]})]})}export{w as component};
