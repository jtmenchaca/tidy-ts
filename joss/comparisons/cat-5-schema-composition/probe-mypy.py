"""Probe: Category 5 — Mypy static type checking of schema composition errors.

Generates a Python file with all 10 cat-5 error cases, runs mypy in strict
...
TARGET_CODE = '''\
"""Cat-5 schema composition cases for mypy static analysis."""
import os
import pandas as pd
import numpy as np
import tempfile
