...
<body>
<h1>Figure 1. Tidy-TS Clinical Data Workflow</h1>
<p class="subtitle">Data flows from external clinical sources through runtime data validation into a compile-time-checked transformation pipeline, then to downstream outputs.</p>
<div class="pipeline">
  ...
  <div class="stage zone-boundary">
    ...
    <div class="stage-label">Data Validation Boundary</div>
    <div class="stage-desc">Runtime validation: rejects unexpected data types, missing required fields, unexpected null values, invalid categorical values. Establishes the data contract for the pipeline.</div>
  </div>
  <div class="arrow"><div class="arrow-line"></div><div class="arrow-head"></div></div>
  <div class="stage zone-typed">
    <span class="badge badge-compile">Compile-time check</span>
    <div class="stage-label">Typed DataFrame</div>
    <div class="stage-desc">Tracks exact type of data in each column, including potential for missing or undefined values. Each data operation can update the tracked column data types.</div>
  </div>
  <div class="arrow"><div class="arrow-line"></div><div class="arrow-head"></div></div>
  <div class="stage zone-typed">
    <span class="badge badge-compile">Compile-time check</span>
    <div class="stage-label">Typed Data Transformations</div>
    <div class="stage-desc">
      select &middot; drop &middot; mutate &middot; rename &middot; filter &middot; arrange &middot; groupBy &middot; summarize<br>
      join &middot; pivotWider &middot; pivotLonger &middot; bindRows &middot; distinct &middot; fillForward &middot; removeNull &middot; &hellip;
    </div>
  </div>
  <div class="arrow"><div class="arrow-line"></div><div class="arrow-head"></div></div>
  <div class="stage zone-typed">
    ...
    <div class="stage-desc">Hypothesis tests, regression (GLM), descriptive statistics &mdash; validated against R within 1e-6</div>
  </div>
  <div class="fork">
  ...
  <div class="parallel">
    <div class="stage zone-output">
      ...
      <div class="stage-label">Application</div>
