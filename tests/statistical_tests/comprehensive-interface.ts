  ...
  switch (params.testType) {
    ...
    case "cor.test.pearson": {
      const { pearsonTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/correlation/pearson.ts"
      );
    ...
    case "cor.test.spearman": {
      const { spearmanTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/correlation/spearman.ts"
      );
    ...
    case "cor.test.kendall": {
      const { kendallTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/correlation/kendall.ts"
      );
    ...
    case "t.test.one": {
      const { tTestOneSample } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/t-tests.ts"
      );
    ...
    case "z.test.one": {
      const { zTestOneSample } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/z-tests.ts"
      );
    ...
    case "prop.test.one": {
      const { proportionTestOneSample } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/proportion-tests.ts"
      );
    ...
    case "wilcox.test.mannwhitney": {
      const { mannWhitneyTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/mann-whitney.ts"
      );
    ...
    case "wilcox.test.signedrank": {
      const { wilcoxonSignedRankTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/wilcoxon.ts"
      );
    ...
    case "kruskal.test": {
      const { kruskalWallisTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/kruskal-wallis.ts"
      );
    ...
    case "ks.test.uniform": {
      const { ksTestUniform } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/kolmogorov-smirnov.ts"
      );
    ...
    case "shapiro.test": {
      const { shapiroWilkTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/shapiro-wilk.ts"
      );
    ...
    case "ad.test": {
      const { andersonDarlingTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/anderson-darling.ts"
      );
    ...
    case "dagostino.test": {
      const { dagostinoPearsonTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/dagostino-pearson.ts"
      );
    ...
    case "chisq.test": {
      const { chiSquareTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/chi-square.ts"
      );
    ...
    case "fisher.test": {
      const { fishersExactTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/fishers-exact.ts"
      );
    ...
    case "levene.test": {
      const { leveneTest } = await import(
        "../../src/dataframe/ts/stats/statistical-tests/levene.ts"
      );
