...
// Getting Started with DataFrames - Progressive Examples
async function runGettingStartedExamples() {
  // ============================================================================
...
Production async operations need concurrency control and retry mechanisms.`,
  ...
  const conditionalCleaned = messyData
    .mutate({
      nameFilled: (row) => row.name || `Person_${row.id}`,
      ageFilled: (row) => {
...
// Run the examples
runGettingStartedExamples().catch(console.error);
