 ...
 * ```
 */
export type AppError<ErrorName extends string, Extra = object> = Error & Extra & {
    name: ErrorName;
};
/**
 ...
 * ```
 */
export declare function defineError<ErrorName extends string, Extra extends object = object>(name: ErrorName, messageTemplate: (extra: Extra) => string): {
 ...
 * ```
 */
export declare function tryAsync<T, E>({ fn, mapError, }: {
    fn: () => Promise<T>;
