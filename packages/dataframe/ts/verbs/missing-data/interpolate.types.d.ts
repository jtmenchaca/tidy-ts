 ...
 */
export type InterpolateMethod = <R extends object, ValueCol extends keyof R & string, XCol extends keyof R & string>(this: DataFrame<R>, valueColumn: ValueCol, xColumn: XCol, method: "linear" | "spline") => DataFrame<R>;
