...
import type { EmptyDataFrameSlice, RestrictEmptyDataFrame } from "../../dataframe/types/error-types.ts";
/**
...
export type SliceRowsMethod<Row extends object> = {
     ...
     * df.groupBy("category").slice(0, 5)
     */
    <R extends object, GroupName extends keyof R>(this: GroupedDataFrame<R, GroupName>, start: RestrictEmptyDataFrame<R, number, EmptyDataFrameSlice>, end?: number): GroupedDataFrame<R, GroupName>;
    /**
     * Extract rows by index range.
     *
     * Returns rows from start index (inclusive) to end index (exclusive), similar to
     ...
     * df.groupBy("category").slice(0, 5)
     */
    (start: RestrictEmptyDataFrame<Row, number, EmptyDataFrameSlice>, end?: number): DataFrame<Row>;
};
export type SliceIndicesMethod<Row extends object> = {
     ...
     */
    <R extends object, GroupName extends keyof R>(this: GroupedDataFrame<R, GroupName>, ...indices: number[]): GroupedDataFrame<R, GroupName>;
    /**
     * Extract specific rows by their indices.
     *
     * Returns rows at the specified index positions. Useful when you need specific
...
export type SliceHeadMethod<Row extends object> = {
     ...
     */
    <R extends object, GroupName extends keyof R>(this: GroupedDataFrame<R, GroupName>, count: RestrictEmptyDataFrame<R, number, EmptyDataFrameSlice>): GroupedDataFrame<R, GroupName>;
    /**
     * Get the first N rows.
     *
     * Returns the specified number of rows from the beginning of the DataFrame.
     ...
     * df.groupBy("category").sliceHead(3)
     */
    (count: RestrictEmptyDataFrame<Row, number, EmptyDataFrameSlice>): DataFrame<Row>;
};
...
export type SliceMinMethod<Row extends object> = {
     ...
     * df.groupBy("category").sliceMin("price", 3)
     */
    <R extends object, GroupName extends keyof R, ColName extends keyof R>(this: GroupedDataFrame<R, GroupName>, columnName: RestrictEmptyDataFrame<R, ColName, EmptyDataFrameSlice>, count: number): GroupedDataFrame<R, GroupName>;
    /**
     * Get rows with the smallest values in a column.
     *
     * Returns the N rows with the smallest values in the specified column.
     ...
     * df.groupBy("category").sliceMin("price", 3)
     */
    <R extends object, ColName extends keyof R>(this: DataFrame<R>, columnName: RestrictEmptyDataFrame<R, ColName, EmptyDataFrameSlice>, count: number): DataFrame<R>;
};
...
export type SliceSampleMethod<Row extends object> = {
     ...
     */
    <R extends object, GroupName extends keyof R>(this: GroupedDataFrame<R, GroupName>, count: RestrictEmptyDataFrame<R, number, EmptyDataFrameSlice>, seed?: number): GroupedDataFrame<R, GroupName>;
    /**
     * Get a random sample of rows.
     *
     * Returns a random sample of N rows from the DataFrame. Optionally provide
     ...
     * df.groupBy("category").sample(3)
     */
    (count: RestrictEmptyDataFrame<Row, number, EmptyDataFrameSlice>, seed?: number): DataFrame<Row>;
};
