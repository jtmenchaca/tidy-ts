...
import type { EmptyDataFrameGroupBy, RestrictEmptyDataFrame } from "../../dataframe/types/error-types.ts";
/**
...
export type GroupByMethod<Row extends object> = {
     ...
     * df.groupBy(["category", "region"])
     */
    <ColName extends keyof Row>(...columnNames: RestrictEmptyDataFrame<Row, ColName[], EmptyDataFrameGroupBy>): GroupedDataFrame<Row, ColName>;
    /**
     * Group DataFrame rows by one or more columns.
     *
     * Creates a GroupedDataFrame where subsequent operations (mutate, summarise, filter, etc.)
     ...
     * df.groupBy(["category", "region"])
     */
    <ColName extends keyof Row>(columns: RestrictEmptyDataFrame<Row, ColName[], EmptyDataFrameGroupBy>): GroupedDataFrame<Row, ColName>;
};
