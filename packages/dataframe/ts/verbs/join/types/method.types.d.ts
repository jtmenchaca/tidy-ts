...
import type { EmptyDataFrameJoin, RestrictEmptyDataFrame } from "../../../dataframe/types/error-types.ts";
import type { DFLike, JoinOptions, ObjectJoinOptions, RowOfLike, SimpleJoinOptions } from "./core.types.ts";
import type { SuffixAwareAsofJoinResult, SuffixAwareInnerJoinResult, SuffixAwareLeftJoinResult, SuffixAwareOuterJoinResult, SuffixAwareRightJoinResult } from "./suffix.types.ts";
/**
...
export type InnerJoinMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, on: RestrictEmptyDataFrame<Row, K | K[], EmptyDataFrameJoin>, options?: SimpleJoinOptions): DataFrame<Prettify<SuffixAwareInnerJoinResult<Row, OtherRow, K>>>;
    /**
     * Join two DataFrames, keeping only matching rows from both.
     *
     * Returns rows where the join key(s) match in both DataFrames. Non-matching rows
     ...
     * })
     */
    <OtherRow extends object, const Keys extends ObjectJoinOptions<Row, OtherRow>["keys"], const Suffixes extends ObjectJoinOptions<Row, OtherRow>["suffixes"]>(other: DataFrame<OtherRow>, options: RestrictEmptyDataFrame<Row, {
        keys: Keys;
        suffixes?: Suffixes;
    }, EmptyDataFrameJoin>): DataFrame<Prettify<SuffixAwareInnerJoinResult<Row, OtherRow, keyof Row & keyof OtherRow, {
        keys: Keys;
        suffixes: Suffixes;
    }>>>;
};
export type InnerJoinDuckDBMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, on: K | K[], options?: JoinOptions): Promise<DataFrame<Prettify<SuffixAwareInnerJoinResult<Row, OtherRow, K>>>>;
};
/**
...
export type LeftJoinMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, on: RestrictEmptyDataFrame<Row, K | K[], EmptyDataFrameJoin>, options?: SimpleJoinOptions): DataFrame<Prettify<SuffixAwareLeftJoinResult<Row, OtherRow, K>>>;
    /**
     * Join two DataFrames, keeping all rows from the left DataFrame.
     *
     * Returns all rows from the left DataFrame with matching data from the right DataFrame
    ...
    <OtherRow extends object, const Keys extends ObjectJoinOptions<Row, OtherRow>["keys"], const Suffixes extends ObjectJoinOptions<Row, OtherRow>["suffixes"]>(other: DataFrame<OtherRow>, options: RestrictEmptyDataFrame<Row, {
        keys: Keys;
        suffixes?: Suffixes;
    }, EmptyDataFrameJoin>): DataFrame<Prettify<SuffixAwareLeftJoinResult<Row, OtherRow, keyof Row & keyof OtherRow, {
        keys: Keys;
        suffixes: Suffixes;
    }>>>;
};
export type LeftJoinParallelMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, on: RestrictEmptyDataFrame<Row, K | K[], EmptyDataFrameJoin>, options?: {
        suffixes?: {
            left?: string;
            right?: string;
        };
    ...
    <OtherRow extends object, const Keys extends ObjectJoinOptions<Row, OtherRow>["keys"], const Suffixes extends ObjectJoinOptions<Row, OtherRow>["suffixes"]>(other: DataFrame<OtherRow>, options: RestrictEmptyDataFrame<Row, {
        ...
        suffixes?: Suffixes;
        workers?: number;
    }, EmptyDataFrameJoin>): Promise<DataFrame<Prettify<SuffixAwareLeftJoinResult<Row, OtherRow, keyof Row & keyof OtherRow, {
        keys: Keys;
        suffixes: Suffixes;
    }>>>>;
};
...
export type RightJoinMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, on: RestrictEmptyDataFrame<Row, K | K[], EmptyDataFrameJoin>, options?: SimpleJoinOptions): DataFrame<Prettify<SuffixAwareRightJoinResult<Row, OtherRow, K>>>;
    /**
     * Join two DataFrames, keeping all rows from the right DataFrame.
     *
     * Returns all rows from the right DataFrame with matching data from the left DataFrame
    ...
    <OtherRow extends object, const Keys extends ObjectJoinOptions<Row, OtherRow>["keys"], const Suffixes extends ObjectJoinOptions<Row, OtherRow>["suffixes"]>(other: DataFrame<OtherRow>, options: RestrictEmptyDataFrame<Row, {
        keys: Keys;
        suffixes?: Suffixes;
    }, EmptyDataFrameJoin>): DataFrame<Prettify<SuffixAwareRightJoinResult<Row, OtherRow, keyof Row & keyof OtherRow, {
        keys: Keys;
        suffixes: Suffixes;
    }>>>;
};
...
export type OuterJoinMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, on: RestrictEmptyDataFrame<Row, K | K[], EmptyDataFrameJoin>, options?: SimpleJoinOptions): DataFrame<Prettify<SuffixAwareOuterJoinResult<Row, OtherRow, K>>>;
    /**
     * Join two DataFrames, keeping all rows from both (full outer join).
     *
     * Returns all rows from both DataFrames. Cells from the side with no matching row are
    ...
    <OtherRow extends object, const Keys extends ObjectJoinOptions<Row, OtherRow>["keys"], const Suffixes extends ObjectJoinOptions<Row, OtherRow>["suffixes"]>(other: DataFrame<OtherRow>, options: RestrictEmptyDataFrame<Row, {
        keys: Keys;
        suffixes?: Suffixes;
    }, EmptyDataFrameJoin>): DataFrame<Prettify<SuffixAwareOuterJoinResult<Row, OtherRow, keyof Row & keyof OtherRow, {
        keys: Keys;
        suffixes: Suffixes;
    }>>>;
};
...
export type CrossJoinMethod<Row extends object> = {
     ...
     * df1.crossJoin(df2, undefined, { left: "_a", right: "_b" })
     */
    <Other extends DFLike<any>, OtherRow extends RowOfLike<Other>>(other: RestrictEmptyDataFrame<Row, Other, EmptyDataFrameJoin>, maxRows?: number, suffixes?: {
        left?: string;
        right?: string;
...
export type AsofJoinMethod<Row extends object> = {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow>(other: DataFrame<OtherRow>, by: RestrictEmptyDataFrame<Row, K, EmptyDataFrameJoin>, options?: {
     ...
     * })
     */
    <OtherRow extends object, K extends keyof Row & keyof OtherRow, const Suffixes extends {
        left?: string;
        right?: string;
    }>(other: DataFrame<OtherRow>, by: RestrictEmptyDataFrame<Row, K, EmptyDataFrameJoin>, options: {
        direction?: "backward" | "forward" | "nearest";
        tolerance?: number;
        group_by?: (keyof Row & keyof OtherRow)[];
        suffixes: Suffixes;
    }): DataFrame<Prettify<SuffixAwareAsofJoinResult<Row, OtherRow, Extract<K, string>, {
        suffixes: Suffixes;
    }>>>;
};
