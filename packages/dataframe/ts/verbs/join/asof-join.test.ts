...
Deno.test("asofJoin - with group_by", () => {
  ...
  expect(result.toArray()).toEqual([
    { symbol: "AAPL", time: 1, order: "buy", price: 100 }, // AAPL: 0 is closest backward
    { symbol: "AAPL", time: 3, order: "sell", price: 102 }, // AAPL: 2 is closest backward
    { symbol: "MSFT", time: 2, order: "buy", price: 200 }, // MSFT: 1 is closest backward
    { symbol: "MSFT", time: 4, order: "sell", price: 205 }, // MSFT: 3 is closest backward
  ]);
});
...
Deno.test("asofJoin - mixed group matching", () => {
  ...
  expect(result.toArray()).toEqual([
    { symbol: "AAPL", time: 1, order: "buy", price: 100 }, // AAPL: 0 is closest backward
    { symbol: "MSFT", time: 1, order: "buy", price: undefined }, // MSFT: no backward match
    { symbol: "AAPL", time: 5, order: "sell", price: 105 }, // AAPL: 4 is closest backward
  ]);
});
