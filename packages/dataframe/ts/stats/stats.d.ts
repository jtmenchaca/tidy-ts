...
import { dunnTest, gamesHowellTest, tukeyHSD } from "./statistical-tests/post-hoc/index.ts";
/**
...
export declare const stats: {
    ...
    readonly test: {
        ...
        readonly nonparametric: {
            ...
            readonly kruskalWallisGroup: typeof statisticalTests.kruskalWallisTestByGroup;
        };
