...
export function CopyButton({
  text,
  className =
    "absolute top-2 right-2 p-2 rounded-md bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors opacity-100 z-10 cursor-pointer",
  ariaLabel = "Copy code",
}: CopyButtonProps) {
