    ...
    >
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-6">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          ...
          tidy-ts achieves near-native performance through Rust's zero-cost
          abstractions and WASM's direct memory access, often performing within
          2-3x of native libraries while maintaining TypeScript's developer
          experience.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Performance comparison across core operations (median of 7 runs with
            5 warmups, ms)
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Alert>
        <AlertDescription>
          <strong>Note:</strong>{" "}
          These benchmarks are based on real performance tests with 500,000
          rows, using median times from 7 iterations with 5 warmup runs. Results
          may vary based on hardware, data characteristics, and specific use
          cases. All tests use optimized data types (categorical/factor) where
          applicable.
        </AlertDescription>
      </Alert>
    </DocPageLayout>
