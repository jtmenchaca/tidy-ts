...
jediAcademyData.print("DataFrame created from Jedi Academy XLSX:");`,
  ...
  parquetReading: `import { type DataFrame } from "@tidy-ts/dataframe";
...
jediData.print("DataFrame from Parquet:");`,
  ...
  arrowReading: `import { type DataFrame } from "@tidy-ts/dataframe";
...
// Write to Arrow
await writeArrow(jediData, "./output/jedi.arrow");`,
};
