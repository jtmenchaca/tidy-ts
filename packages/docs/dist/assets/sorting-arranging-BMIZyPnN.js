import{j as e}from"./radix-C5HsujcS.js";import{C as r}from"./code-block-DfPeKR4P.js";import{D as a}from"./DocPageLayout-BcaZHC9d.js";import"./recharts-C_nxoP3K.js";import"./shiki-nSPdDrzn.js";import"./card-D02YvoDr.js";import"./index-BBlg4lkL.js";import"./shiki-themes-DQugEEWh.js";const t={basicSorting:`import { createDataFrame } from "@tidy-ts/dataframe";
...
sortedByPrice.print("Products sorted by price:");`};function m(){return e.jsxs(a,{title:"Sorting / Arranging Data",description:"Sort your data to understand patterns, find extremes, and organize information for better analysis. tidy-ts provides flexible sorting with full type safety.",currentPath:"/sorting-arranging",children:[e.jsx(r,{id:"basic-sorting",title:"Basic Sorting",description:"Sort by a single column in ascending or descending order",explanation:"The arrange() function sorts your DataFrame by one or more columns. By default, sorting is ascending, but you can specify 'desc' for descending order.",code:t.basicSorting}),e.jsx(r,{id:"multiple-column-sorting",title:"Multiple Column Sorting",description:"Sort by multiple columns with different orders",explanation:"You can sort by multiple columns by passing an array. The DataFrame will be sorted by the first column, then by the second column within groups of equal values in the first column, and so on.",code:t.multiColumnSorting}),e.jsx(r,{id:"sorting-with-calculated-values",title:"Sorting with Calculated Values",description:"Sort by values calculated from existing columns",explanation:"You can sort by any column, including calculated ones. This is particularly useful for finding the highest or lowest values after performing transformations.",code:t.sortingWithCalculatedValues}),e.jsx(r,{id:"finding-extremes",title:"Finding Extremes",description:"Common sorting patterns for finding top performers",explanation:"Use sorting to find the highest or lowest values in your data, or the best performer in each group.",code:t.findingTopPerformers}),e.jsx(r,{id:"categorical-sorting",title:"Categorical Sorting",description:"Sorting string and categorical data",explanation:"Sort text data alphabetically or by custom order. Useful for organizing names, categories, or any text-based data.",code:t.stringSorting})]})}export{m as component};
