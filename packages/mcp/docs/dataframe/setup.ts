...
export const setupDocs: Record<string, DocEntry> = {
  ...
  architecture: {
    ...
    bestPractices: [
      ...
      "✓ PREFER COLUMN ACCESS: Use df.columnName instead of df.toRows() for better performance",
