...
export const nonparametricDocs: Record<string, DocEntry> = {
  "s.test.nonparametric.mannWhitney": {
    ...
    returns: "MannWhitneyTestResult with `statistic`, `pValue`, `reject`",
    examples: [
  ...
  "s.test.nonparametric.wilcoxon": {
    ...
    returns:
      "WilcoxonSignedRankTestResult with `statistic`, `pValue`, `reject`",
    examples: [
  ...
  "s.test.nonparametric.kruskalWallis": {
    ...
    returns:
      "KruskalWallisTestResult with `statistic`, `pValue`, `degreesOfFreedom`, `reject`",
    examples: [
      "const group1 = [10, 12, 11, 13, 12];",
      "const group2 = [15, 16, 14, 17, 15];",
