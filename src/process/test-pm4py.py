#!/usr/bin/env python3
"""
Simple PM4Py OCEL test - loads CSV and creates visualizations
Run with: cd src/process && poetry run python test-pm4py.py
"""
...
try:
    freq_path = fixtures_dir / "test_ocdfg_frequency.png"
...
try:
    perf_path = fixtures_dir / "test_ocdfg_performance.png"
...
try:
    ...
    ocpn_path = fixtures_dir / "test_ocpn.png"
