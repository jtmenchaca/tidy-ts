...
pub use influence_measures::{
    influence_measures, InfluenceMeasuresResult, InfluenceResult
};
pub use influence_generic::{
    LinearModel, influence, influence_lm, influence_glm, hatvalues, hatvalues_lm
};
pub use influence_core::{
    QrLsResult, lm_influence
};
