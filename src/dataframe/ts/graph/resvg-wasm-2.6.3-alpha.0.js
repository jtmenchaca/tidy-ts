...
export { initWasm, Resvg2 as Resvg };
...
var Resvg = class {
  ...
  constructor(svg, options, custom_font_buffers) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      var ptr0 = isLikeNone(options) ? 0 : passStringToWasm0(
        options,
      ...
      wasm.resvg_new(
        ...
        ptr0,
        len0,
        isLikeNone(custom_font_buffers)
          ? 0
          : addHeapObject(custom_font_buffers),
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
  ...
  cropByBBox(bbox, padding, square) {
    ...
    wasm.resvg_cropByBBox(
      this.__wbg_ptr,
      bbox.__wbg_ptr,
      !isLikeNone(padding),
      isLikeNone(padding) ? 0 : padding,
      isLikeNone(square) ? 16777215 : square ? 1 : 0,
    );
  }
  /**
   * @returns {Array<any>}
...
async function __wbg_init(input) {
  ...
  if (typeof input === "undefined") {
    input = new URL("resvg-wasm-2.6.3-alpha.0_bg.wasm", void 0);
  }
