import { strDetect } from "./str_detect.ts";
import { strLength } from "./str_length.ts";
import { strReplace, strReplaceAll } from "./str_replace.ts";
import { strExtract, strExtractAll } from "./str_extract.ts";
import { strSplit, strSplitFixed } from "./str_split.ts";
