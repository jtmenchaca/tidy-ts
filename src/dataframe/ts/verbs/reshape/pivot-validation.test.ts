...
try {
  const result = salesData
    .pivotWider({
      names_from: "product",
      values_from: "revenue",
      expected_columns: ["apples", "bananas"], // Missing "cherries"
    });
...
try {
  const result = salesData
    .pivotWider({
      names_from: "product",
      values_from: "revenue",
      expected_columns: ["apples", "bananas", "cherries", "dates"], // Extra "dates"
    });
  console.log("Success:", result);
} catch (error) {
  console.log(
...
try {
  const result = salesData
    .pivotWider({
      names_from: "product",
      values_from: "revenue",
      expected_columns: ["apples", "oranges", "cherries"], // "oranges" instead of "bananas"
    });
  console.log("Success:", result);
} catch (error) {
  console.log(
...
try {
  const result = salesData
    .pivotWider({
      names_from: "product",
      values_from: "revenue",
      expected_columns: ["apples", "bananas", "cherries"], // Correct!
    });
  console.log("Success! Result:");
  console.log(result);
} catch (error) {
...
try {
  const result = salesData
    .pivotWider({
      names_from: "product",
      values_from: "revenue",
      expected_columns: stats.unique(salesData.product), // Always correct!
    });
  console.log("Success! Result:");
  console.log(result);
} catch (error) {
...
console.log("\n--- Test 6: No expected_columns (no validation) ---");
try {
  const result = salesData
    .pivotWider({
      names_from: "product",
      values_from: "revenue",
      // No expected_columns - will work but return Record<string, unknown>
    });
  console.log("Success! Result:");
  console.log(result);
} catch (error) {
