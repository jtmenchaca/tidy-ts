    ...
    if (result.factor_a) {
      serialized.factor_a = {
        ...
        effect_size: result.factor_a.effect_size ? {
          ...
          effect_type: result.factor_a.effect_size.effect_type
        } : undefined,
    ...
    if (result.factor_b) {
      serialized.factor_b = {
        ...
        effect_size: result.factor_b.effect_size ? {
          ...
          effect_type: result.factor_b.effect_size.effect_type
        } : undefined,
    ...
    if (result.interaction) {
      serialized.interaction = {
        ...
        effect_size: result.interaction.effect_size ? {
          ...
          effect_type: result.interaction.effect_size.effect_type
        } : undefined,
